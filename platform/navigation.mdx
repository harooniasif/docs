...
![Overview Page Interface](/images/overveiw%20page.png)
...
<AccordionGroup>
  ...
  <Accordion icon="users" title="Discovered Brands Section">
  ...
  <Accordion icon="lightbulb" title="Prompts Section">
  ...
  <Accordion icon="magnifying-glass" title="Keyword Phrases Section">
    **Language and SEO Analysis:**
