...
<CardGroup cols={2}>
  <Card title="Brand Setup" icon="building" href="/account-setup">
    Configure your brand details and competitor information
  </Card>
  <Card title="Create Topics & Prompts" icon="plus-circle" href="/platform/create-topics">
    Set up monitoring topics and AI prompts
  </Card>
  <Card title="Platform Navigation" icon="compass" href="/platform/navigation">
    Learn to navigate the BrandRadar interface
  </Card>
  <Card title="Understanding Data" icon="chart-bar" href="/platform/understanding-data">
    Interpret metrics and insights
  </Card>
</CardGroup>
